...
Only requiring some minor changes is dacash.cpp.
...
Changes to dacash.cpp
----------------------
dacash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
