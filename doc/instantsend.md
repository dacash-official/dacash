...
This mechanism has been integrated into Bitcore-Node-DACash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dacash-official/insight-api-dacash#web-socket-api](https://github.com/dacash-official/insight-api-dacash#web-socket-api)
* API: [https://github.com/dacash-official/insight-api-dacash#instantsend-transactions](https://github.com/dacash-official/insight-api-dacash#instantsend-transactions)
...
By default, the DACash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DACash Core daemon:
