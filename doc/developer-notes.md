...
DACash Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 56000.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 56001 for connections and services them.
...
However, in open source software such as DACash Core, where everyone uses
...
pay attention to for reviewers of DACash Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: DACash Core uses tinyformat, which is type safe. Leave them out to avoid confusion
