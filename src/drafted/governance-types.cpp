...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DACashNetwork") type = DACashNetwork;
    if(strType == "DACashNetworkVariable") type = DACashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DACashNetwork) s = "DACashNetwork";
    if(type == DACashNetworkVariable) s = "DACashNetworkVariable";
