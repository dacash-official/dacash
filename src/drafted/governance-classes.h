 ...
 *
 *   // network
 *   CDACashNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.dacash.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDACashNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: DACashNetwork
// //   -- signature requirements : Key1(User)
// class CDACashNetworkVariable : public CGovernanceObject
// {
// private:
