...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all DACash related functionality
...
/*
    ...
    allow endless transaction that would bloat DACash and make it unusable. To
