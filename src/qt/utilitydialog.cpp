    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("DACash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About DACash Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  dacash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the DACash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DAC, 0.1 DAC, 1 DAC and 10 DAC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://dacashpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://dacashpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("DACash Core is shutting down...") + "<br /><br />" +
