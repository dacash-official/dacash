    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("DACash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DACash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dacash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About DACash Core"), this);
    aboutAction->setStatusTip(tr("Show information about DACash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DACash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DACash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DACash addresses"));
    ...
    openAction->setStatusTip(tr("Open a dacash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DACash Core help message to get a list with possible DACash Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("DACash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DACash network", "", count));
    } else {
...
{
    QString strTitle = tr("DACash Core"); // default title
