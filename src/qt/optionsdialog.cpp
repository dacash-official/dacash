    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DACASH-light"), QVariant("light"));
    ui->theme->addItem(QString("DACASH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("DACASH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DACASH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DACASH-traditional"), QVariant("trad"));
