...
#define BOOST_TEST_MODULE DACash Test Suite

#include "test_dacash.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_dacash_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
